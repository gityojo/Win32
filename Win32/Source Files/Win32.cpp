...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIconSm = LoadIcon(wcex.hInstance, MAKEINTRESOURCE(IDI_WIN32));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	HWND hWnd = CreateWindowW(szWindowClass, L"Win32", WS_OVERLAPPEDWINDOW,
		150, 30, 810, 540, nullptr, nullptr, hInstance, nullptr);
